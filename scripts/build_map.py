...
<style>
  ...
  /* the "near an esker" cue is a thick polygon outline, so its key is an
     outline rather than a fill */
  .legend .swatch.edge { background: #fff; box-shadow: inset 0 0 0 2px #15653a; }
...
function style(feature) {
  ...
  return {
    color: c.line,
    weight: p.near_esker ? 2.5 : 1,
    opacity: p.near_esker ? 0.95 : 0.6,
    fillColor: c.fill,
...
legend.innerHTML =
  ...
  '<span><span class="swatch edge"></span>Lähellä harjumuodostumaa</span>' +
